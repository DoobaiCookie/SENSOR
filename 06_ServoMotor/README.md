...
```
# 초기위치 설정 테스트
<img width="300" height="500" alt="image" src="https://github.com/user-attachments/assets/0ec64067-c846-45a3-aba4-462af3614c18" />

# 오실로스코프 파형 확인

| 전체 주기 | Pan = 125 (2.5ms) | Pan = 45 (0.9ms) Tilt = 125 (2.5ms) |
|------|------|------|
...
```
# 테스트 결과
<img width="680" height="644" alt="image" src="https://github.com/user-attachments/assets/70afd9be-129b-45f9-bd83-fbb1a3e323c8" />
